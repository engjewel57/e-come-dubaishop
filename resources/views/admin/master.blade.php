...
<!-- Mirrored from demo.dashboardpack.com/cryptocurrency-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Sep 2022 03:39:12 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <title>DubaiShop | @yield('title')</title>

    <link rel="icon" href="{{asset('/')}}admin/assets/img/mini_logo.png" type="{{asset('/')}}admin/assets/image/png">
    <!-- Bootstrap CSS -->
...
<nav class="sidebar dark_sidebar">
    <div class="logo d-flex justify-content-between">
        <a class="large_logo" href="index.html"><img src="{{asset('/')}}admin/assets/img/logo_white.png" alt=""></a>
        <a class="small_logo" href="index.html"><img src="{{asset('/')}}admin/assets/img/mini_logo.png" alt=""></a>
    ...
    <ul id="sidebar_menu">
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                ...
                <div class="nav_title">
                    <span>Sub-Category Model </span>
                </div>
            </a>
            <ul>
                <li><a href="{{route('sub_category.add')}}">Add Sub-Category</a></li>
                <li><a href="{{route('sub_category.manage')}}">Manage Sub-Category</a></li>
            </ul>
        </li>
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{asset('/')}}admin/assets/img/menu-icon/Pages.svg" alt="">
                </div>
                <div class="nav_title">
        ...
        <li class="">
            <a  class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{asset('/')}}admin/assets/img/menu-icon/General.svg" alt="">
                </div>
                <div class="nav_title">
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{asset('/')}}admin/assets/img/menu-icon/Mail_Box.svg" alt="">
                </div>
                <div class="nav_title">
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{asset('/')}}admin/assets/img/menu-icon/icon.svg" alt="">
                </div>
                <div class="nav_title">
            ...
            <ul>
                <li><a href="{{route('order.manage')}}">Manage Order</a></li>
            </ul>
        </li>
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
            ...
            <ul>
                <li><a href="colors.html">Add User</a></li>
                <li><a href="Alerts.html">Manage User</a></li>
            </ul>
        </li>
    </ul>
</nav>
                ...
                <div class="header_iner d-flex justify-content-between align-items-center">
                    ...
                    <div class="header_right d-flex justify-content-between align-items-center">
                        <div class="header_notification_warp d-flex align-items-center">
                            <li>
                                <a class="CHATBOX_open nav-link-notify" href="#"> <img src="{{asset('/')}}admin/assets/img/icon/msg.svg" alt="">   </a>
                            </li>
                            <li>
                                <a class="bell_notification_clicker nav-link-notify" href="#"> <img src="{{asset('/')}}admin/assets/img/icon/bell.svg" alt="">
                                    <!-- <span>2</span> -->
                                </a>
                        ...
                        <div class="profile_info d-flex align-items-center">
                            <div class="profile_thumb mr_20">
                                <img src="{{asset('/')}}admin/assets/img/12.jpg" alt="#">
                            </div>
                            <div class="author_name">
                                <h4 class="f_s_15 f_w_500 mb-0">Shahidul Islam</h4>
                                <p class="f_s_12 f_w_400">Manager</p>
                            </div>
                            <div class="profile_info_iner">
                                <div class="profile_author_name">
                                    <p>Manager</p>
                                    <h5>Shahidul Islam</h5>
                                </div>
                                <div class="profile_info_details">
                                    <a href="#">My Profile </a>
                                    <a href="#">Settings</a>
                                    <a class="dropdown-item text-danger" href="#" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();">Log Out </a>
