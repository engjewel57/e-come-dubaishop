                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('category.update',['id'=>$category->id])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-9">
                                    <textarea type="description" name="description" class="form-control"id="horizontal-firstname-input">{{$category->description}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row md-4">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <img src="{{asset($category->image)}}" alt="" height="80" width="90">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="" class="col-sm-3 ">Publication</label>
                                <div class="col-sm-9">
                                    <label class="mr-3"><input type="radio" name="status" {{$category->published == 1 ? 'checked' : ' '}} value="1" checked />published</label>
                                    <label><input type="radio" name="status" {{$category->unpublished == 0 ? 'checked' : ' '}} value="0" />unpublished</label>
                                </div>
                            </div>
